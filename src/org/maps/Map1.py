...
PACMAN_SPEED = 1.0 * DrawingGenerics.PIXEL # 80% max speed
PACMAN_SPEED_FRIGHT = 1.14 * DrawingGenerics.PIXEL # 90% max speed

GHOST_SPEED = 1.0 * DrawingGenerics.PIXEL # 80% max speed
GHOST_SPEED_EATEN = 2 * DrawingGenerics.PIXEL # 160% max speed
GHOST_SPEED_TUNNEL = 0.5 * DrawingGenerics.PIXEL # 40% max speed
GHOST_SPEED_FRIGHT = 0.62 * DrawingGenerics.PIXEL # 50% max speed
...
GHOST_FRIGHT_CYCLES = DrawingGenerics.CYCLES_PER_SECOND * 6
